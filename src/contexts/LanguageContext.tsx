...
const strings: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Wellness Plan
    "nav.wellnessPlan": "My Wellness Plan",
    "wellness.title": "Your personalized wellness plan",
    "wellness.sub": "Answer a few questions and we'll create a plan that fits your life, your beliefs, and your health goals.",
    "wellness.yourPreferences": "Your Preferences",
    "wellness.aboutYou": "About you",
    "wellness.ageRange": "Age range",
    "wellness.healthGoals": "Health goals",
    "wellness.conditions": "Any diagnosed conditions (optional)",
    "wellness.conditionsPlaceholder": "e.g. diabetes, hypertension — optional",
    "wellness.dietTitle": "Diet preferences",
    "wellness.exerciseTitle": "Exercise",
    "wellness.activityLevel": "Current activity level",
    "wellness.limitations": "Physical limitations (optional)",
    "wellness.limitationsPlaceholder": "e.g. bad knees, limited mobility",
    "wellness.beliefsTitle": "Beliefs & preferences",
    "wellness.beliefsNote": "These preferences help us tailor suggestions. We never promote unproven treatments.",
    "wellness.generate": "Generate my plan →",
    "wellness.yourPlan": "Your Wellness Plan",
    "wellness.regenerate": "Regenerate",
    "wellness.sources": "Sources",
    "wellness.section.nutrition": "Nutrition recommendations",
    "wellness.section.exercise": "Exercise plan",
    "wellness.section.stressSleep": "Stress & sleep",
    "wellness.section.supplements": "Supplements",
    "wellness.section.mindfulness": "Spiritual & mindfulness",
    "wellness.disclaimer": "This wellness plan is for educational purposes only and is not medical advice. Always consult your doctor before making changes to your health routine.",
    "wellness.meta.title": "My Wellness Plan | Clarify Health",
    "wellness.meta.desc": "Get a personalized, evidence-based wellness plan tailored to your goals, diet, and beliefs.",
  },
  es: {
    // Nav / global
    "nav.topics": "Temas",
    ...
    "nav.wellnessPlan": "Mi plan de bienestar",
    "wellness.title": "Tu plan de bienestar personalizado",
    "wellness.sub": "Responde algunas preguntas y crearemos un plan que se adapte a tu vida, tus creencias y tus metas de salud.",
    "wellness.yourPreferences": "Tus preferencias",
    "wellness.aboutYou": "Sobre ti",
    "wellness.ageRange": "Rango de edad",
    "wellness.healthGoals": "Metas de salud",
    "wellness.conditions": "Condiciones diagnosticadas (opcional)",
    "wellness.conditionsPlaceholder": "ej. diabetes, hipertensión — opcional",
    "wellness.dietTitle": "Preferencias de dieta",
    "wellness.exerciseTitle": "Ejercicio",
    "wellness.activityLevel": "Nivel de actividad actual",
    "wellness.limitations": "Limitaciones físicas (opcional)",
    "wellness.limitationsPlaceholder": "ej. rodillas malas, movilidad limitada",
    "wellness.beliefsTitle": "Creencias y preferencias",
    "wellness.beliefsNote": "Estas preferencias nos ayudan a personalizar las sugerencias. Nunca promovemos tratamientos no probados.",
    "wellness.generate": "Generar mi plan →",
    "wellness.yourPlan": "Tu plan de bienestar",
    "wellness.regenerate": "Regenerar",
    "wellness.sources": "Fuentes",
    "wellness.section.nutrition": "Recomendaciones de nutrición",
    "wellness.section.exercise": "Plan de ejercicio",
    "wellness.section.stressSleep": "Estrés y sueño",
    "wellness.section.supplements": "Suplementos",
    "wellness.section.mindfulness": "Espiritualidad y meditación",
    "wellness.disclaimer": "Este plan es solo para fines educativos y no es consejo médico. Siempre consulta a tu doctor.",
    "wellness.meta.title": "Mi Plan de Bienestar | Clarify Health",
    "wellness.meta.desc": "Obtén un plan de bienestar personalizado basado en evidencia.",
  },
  ur: {
    // Nav / global
    "nav.topics": "موضوعات",
    ...
    "nav.wellnessPlan": "میرا فلاحی منصوبہ",
    "wellness.title": "آپ کا ذاتی فلاحی منصوبہ",
    "wellness.sub": "چند سوالات کے جوابات دیں اور ہم آپ کی زندگی، عقائد اور صحت کے اہداف کے مطابق منصوبہ بنائیں گے۔",
    "wellness.yourPreferences": "آپ کی ترجیحات",
    "wellness.aboutYou": "آپ کے بارے میں",
    "wellness.ageRange": "عمر کی حد",
    "wellness.healthGoals": "صحت کے اہداف",
    "wellness.conditions": "تشخیص شدہ حالات (اختیاری)",
    "wellness.conditionsPlaceholder": "مثلاً ذیابیطس، ہائی بلڈ پریشر",
    "wellness.dietTitle": "غذائی ترجیحات",
    "wellness.exerciseTitle": "ورزش",
    "wellness.activityLevel": "موجودہ سرگرمی کی سطح",
    "wellness.limitations": "جسمانی حدود (اختیاری)",
    "wellness.limitationsPlaceholder": "مثلاً گھٹنوں کا درد",
    "wellness.beliefsTitle": "عقائد اور ترجیحات",
    "wellness.beliefsNote": "یہ ترجیحات ہمیں تجاویز کو اپنی مرضی کے مطابق بنانے میں مدد کرتی ہیں۔",
    "wellness.generate": "میرا منصوبہ بنائیں →",
    "wellness.yourPlan": "آپ کا فلاحی منصوبہ",
    "wellness.regenerate": "دوبارہ بنائیں",
    "wellness.sources": "ذرائع",
    "wellness.section.nutrition": "غذائی سفارشات",
    "wellness.section.exercise": "ورزش کا منصوبہ",
    "wellness.section.stressSleep": "تناؤ اور نیند",
    "wellness.section.supplements": "سپلیمنٹس",
    "wellness.section.mindfulness": "روحانیت اور مراقبہ",
    "wellness.disclaimer": "یہ منصوبہ صرف تعلیمی مقاصد کے لیے ہے۔ ہمیشہ اپنے ڈاکٹر سے مشورہ کریں۔",
    "wellness.meta.title": "میرا فلاحی منصوبہ | Clarify Health",
    "wellness.meta.desc": "اپنے اہداف اور ترجیحات کے مطابق ذاتی فلاحی منصوبہ حاصل کریں۔",
  },
  hi: {
    // Nav / global
    "nav.topics": "विषय",
    ...
    "nav.wellnessPlan": "मेरी वेलनेस योजना",
    "wellness.title": "आपकी व्यक्तिगत वेलनेस योजना",
    "wellness.sub": "कुछ सवालों के जवाब दें और हम आपके जीवन, विश्वासों और स्वास्थ्य लक्ष्यों के अनुसार योजना बनाएंगे।",
    "wellness.yourPreferences": "आपकी प्राथमिकताएं",
    "wellness.aboutYou": "आपके बारे में",
    "wellness.ageRange": "आयु सीमा",
    "wellness.healthGoals": "स्वास्थ्य लक्ष्य",
    "wellness.conditions": "निदान की गई स्थितियां (वैकल्पिक)",
    "wellness.conditionsPlaceholder": "जैसे मधुमेह, उच्च रक्तचाप",
    "wellness.dietTitle": "आहार प्राथमिकताएं",
    "wellness.exerciseTitle": "व्यायाम",
    "wellness.activityLevel": "वर्तमान गतिविधि स्तर",
    "wellness.limitations": "शारीरिक सीमाएं (वैकल्पिक)",
    "wellness.limitationsPlaceholder": "जैसे घुटनों में दर्द",
    "wellness.beliefsTitle": "विश्वास और प्राथमिकताएं",
    "wellness.beliefsNote": "ये प्राथमिकताएं हमें सुझावों को अनुकूलित करने में मदद करती हैं।",
    "wellness.generate": "मेरी योजना बनाएं →",
    "wellness.yourPlan": "आपकी वेलनेस योजना",
    "wellness.regenerate": "फिर से बनाएं",
    "wellness.sources": "स्रोत",
    "wellness.section.nutrition": "पोषण सिफारिशें",
    "wellness.section.exercise": "व्यायाम योजना",
    "wellness.section.stressSleep": "तनाव और नींद",
    "wellness.section.supplements": "सप्लीमेंट्स",
    "wellness.section.mindfulness": "आध्यात्मिकता और ध्यान",
    "wellness.disclaimer": "यह योजना केवल शैक्षिक उद्देश्यों के लिए है। हमेशा अपने डॉक्टर से परामर्श करें।",
    "wellness.meta.title": "मेरी वेलनेस योजना | Clarify Health",
    "wellness.meta.desc": "अपने लक्ष्यों और प्राथमिकताओं के अनुसार व्यक्तिगत वेलनेस योजना प्राप्त करें।",
  },
  ar: {
    // Nav / global
    "nav.topics": "المواضيع",
    ...
    "nav.wellnessPlan": "خطة العافية الخاصة بي",
    "wellness.title": "خطة العافية المخصصة لك",
    "wellness.sub": "أجب عن بعض الأسئلة وسننشئ خطة تناسب حياتك ومعتقداتك وأهدافك الصحية.",
    "wellness.yourPreferences": "تفضيلاتك",
    "wellness.aboutYou": "عنك",
    "wellness.ageRange": "الفئة العمرية",
    "wellness.healthGoals": "الأهداف الصحية",
    "wellness.conditions": "الحالات المشخصة (اختياري)",
    "wellness.conditionsPlaceholder": "مثل السكري، ارتفاع ضغط الدم",
    "wellness.dietTitle": "تفضيلات الغذاء",
    "wellness.exerciseTitle": "التمارين",
    "wellness.activityLevel": "مستوى النشاط الحالي",
    "wellness.limitations": "القيود الجسدية (اختياري)",
    "wellness.limitationsPlaceholder": "مثل آلام الركبة",
    "wellness.beliefsTitle": "المعتقدات والتفضيلات",
    "wellness.beliefsNote": "تساعدنا هذه التفضيلات في تخصيص الاقتراحات. لا نروّج أبدًا لعلاجات غير مثبتة.",
    "wellness.generate": "أنشئ خطتي →",
    "wellness.yourPlan": "خطة العافية الخاصة بك",
    "wellness.regenerate": "إعادة إنشاء",
    "wellness.sources": "المصادر",
    "wellness.section.nutrition": "توصيات التغذية",
    "wellness.section.exercise": "خطة التمارين",
    "wellness.section.stressSleep": "التوتر والنوم",
    "wellness.section.supplements": "المكملات",
    "wellness.section.mindfulness": "الروحانية والتأمل",
    "wellness.disclaimer": "هذه الخطة لأغراض تعليمية فقط وليست نصيحة طبية. استشر طبيبك دائمًا.",
    "wellness.meta.title": "خطة العافية | Clarify Health",
    "wellness.meta.desc": "احصل على خطة عافية مخصصة بناءً على أهدافك وتفضيلاتك.",
  },
};
