...
const strings: Record<Language, Record<string, string>> = {
  ...
  es: {
    ...
    "nav.findDoctor": "Buscar doctor",
    "findDoctor.title": "Encuentra el doctor adecuado para ti.",
    "findDoctor.sub": "Dinos qué te pasa y te ayudaremos a encontrar al especialista correcto cerca de ti.",
    "findDoctor.step1": "¿Qué te pasa?",
    "findDoctor.symptomsPlaceholder": "Describe tus síntomas o condición en palabras simples...",
    "findDoctor.step2": "¿Dónde estás?",
    "findDoctor.zipPlaceholder": "Código postal",
    "findDoctor.useLocation": "Usar mi ubicación",
    "findDoctor.preferences": "Preferencias",
    "findDoctor.insurance": "Tipo de seguro",
    "findDoctor.gender": "Preferencia de género",
    "findDoctor.language": "Idioma",
    "findDoctor.acceptingNew": "Acepta nuevos pacientes",
    "findDoctor.searchButton": "Buscar doctores →",
    "findDoctor.specialtyDetected": "Especialidad recomendada",
    "findDoctor.resultsFound": "doctores encontrados",
    "findDoctor.noResults": "No se encontraron doctores en esta área. Intenta con otro código postal.",
    "findDoctor.whyThisDoctor": "Por qué este doctor",
    "findDoctor.viewProfile": "Ver perfil",
    "findDoctor.disclaimer": "Información de doctores del Registro Nacional de Proveedores NPI. Clarify Health no respalda a ningún proveedor.",
    "findDoctor.meta.title": "Buscar un Doctor | Clarify Health",
    "findDoctor.meta.desc": "Describe tus síntomas y encuentra al especialista adecuado cerca de ti.",
  },
  ur: {
    // Nav / global
    "nav.topics": "موضوعات",
    ...
    "findDoctor.title": "اپنے لیے صحیح ڈاکٹر تلاش کریں۔",
    "findDoctor.sub": "ہمیں بتائیں کہ آپ کو کیا مسئلہ ہے اور ہم آپ کو قریبی ماہر تلاش کرنے میں مدد کریں گے۔",
    "findDoctor.step1": "آپ کو کیا مسئلہ ہے؟",
    "findDoctor.symptomsPlaceholder": "اپنی علامات یا حالت سادہ الفاظ میں بیان کریں...",
    "findDoctor.step2": "آپ کہاں ہیں؟",
    "findDoctor.zipPlaceholder": "زپ کوڈ",
    "findDoctor.useLocation": "میرا مقام استعمال کریں",
    "findDoctor.preferences": "ترجیحات",
    "findDoctor.insurance": "انشورنس کی قسم",
    "findDoctor.gender": "صنف کی ترجیح",
    "findDoctor.language": "زبان",
    "findDoctor.acceptingNew": "نئے مریض قبول کرتا ہے",
    "findDoctor.searchButton": "ڈاکٹر تلاش کریں →",
    "findDoctor.specialtyDetected": "تجویز کردہ تخصص",
    "findDoctor.resultsFound": "ڈاکٹر ملے",
    "findDoctor.noResults": "اس علاقے میں کوئی ڈاکٹر نہیں ملا۔ مختلف زپ کوڈ آزمائیں۔",
    "findDoctor.whyThisDoctor": "یہ ڈاکٹر کیوں",
    "findDoctor.viewProfile": "پروفائل دیکھیں",
    "findDoctor.disclaimer": "ڈاکٹروں کی معلومات NPI نیشنل پرووائیڈر رجسٹری سے حاصل کی گئی ہیں۔",
    "findDoctor.meta.title": "ڈاکٹر تلاش کریں | Clarify Health",
    "findDoctor.meta.desc": "اپنی علامات بیان کریں اور اپنے قریب صحیح ماہر تلاش کریں۔",
  },
  hi: {
    // Nav / global
    "nav.topics": "विषय",
    ...
    "findDoctor.title": "अपने लिए सही डॉक्टर खोजें।",
    "findDoctor.sub": "हमें बताएं कि आपको क्या समस्या है और हम आपके पास सही विशेषज्ञ खोजने में मदद करेंगे।",
    "findDoctor.step1": "आपको क्या समस्या है?",
    "findDoctor.symptomsPlaceholder": "अपने लक्षण या स्थिति सरल भाषा में बताएं...",
    "findDoctor.step2": "आप कहाँ हैं?",
    "findDoctor.zipPlaceholder": "ज़िप कोड",
    "findDoctor.useLocation": "मेरा स्थान उपयोग करें",
    "findDoctor.preferences": "प्राथमिकताएं",
    "findDoctor.insurance": "बीमा प्रकार",
    "findDoctor.gender": "लिंग प्राथमिकता",
    "findDoctor.language": "भाषा",
    "findDoctor.acceptingNew": "नए मरीज स्वीकार करता है",
    "findDoctor.searchButton": "डॉक्टर खोजें →",
    "findDoctor.specialtyDetected": "अनुशंसित विशेषता",
    "findDoctor.resultsFound": "डॉक्टर मिले",
    "findDoctor.noResults": "इस क्षेत्र में कोई डॉक्टर नहीं मिला। दूसरा ज़िप कोड आज़माएं।",
    "findDoctor.whyThisDoctor": "यह डॉक्टर क्यों",
    "findDoctor.viewProfile": "प्रोफ़ाइल देखें",
    "findDoctor.disclaimer": "डॉक्टर की जानकारी NPI नेशनल प्रोवाइडर रजिस्ट्री से प्राप्त।",
    "findDoctor.meta.title": "डॉक्टर खोजें | Clarify Health",
    "findDoctor.meta.desc": "अपने लक्षण बताएं और अपने पास सही विशेषज्ञ खोजें।",
  },
  ar: {
    // Nav / global
    "nav.topics": "المواضيع",
    ...
    "findDoctor.title": "ابحث عن الطبيب المناسب لك.",
    "findDoctor.sub": "أخبرنا بما تعاني منه وسنساعدك في العثور على المتخصص المناسب بالقرب منك.",
    "findDoctor.step1": "ما الذي تعاني منه؟",
    "findDoctor.symptomsPlaceholder": "صِف أعراضك أو حالتك بلغة بسيطة...",
    "findDoctor.step2": "أين أنت؟",
    "findDoctor.zipPlaceholder": "الرمز البريدي",
    "findDoctor.useLocation": "استخدم موقعي",
    "findDoctor.preferences": "التفضيلات",
    "findDoctor.insurance": "نوع التأمين",
    "findDoctor.gender": "تفضيل الجنس",
    "findDoctor.language": "اللغة",
    "findDoctor.acceptingNew": "يقبل مرضى جدد",
    "findDoctor.searchButton": "ابحث عن أطباء →",
    "findDoctor.specialtyDetected": "التخصص الموصى به",
    "findDoctor.resultsFound": "أطباء وُجدوا",
    "findDoctor.noResults": "لم يتم العثور على أطباء في هذه المنطقة. جرّب رمزًا بريديًا مختلفًا.",
    "findDoctor.whyThisDoctor": "لماذا هذا الطبيب",
    "findDoctor.viewProfile": "عرض الملف الشخصي",
    "findDoctor.disclaimer": "معلومات الأطباء من سجل مقدمي الخدمات الوطني NPI.",
    "findDoctor.meta.title": "ابحث عن طبيب | Clarify Health",
    "findDoctor.meta.desc": "صِف أعراضك واعثر على المتخصص المناسب بالقرب منك.",
  },
};
